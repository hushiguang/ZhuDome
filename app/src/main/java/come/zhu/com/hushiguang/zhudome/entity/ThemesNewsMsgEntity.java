 ...
 */
public class ThemesNewsMsgEntity implements Serializable {
    ...
    public void setEditors(ArrayList<EditorsEntity> editors) {
    ...
    public ArrayList<EditorsEntity> getEditors() {
        return editors;
    }
