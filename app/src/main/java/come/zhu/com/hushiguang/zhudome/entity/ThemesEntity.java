...
public class ThemesEntity implements Serializable{
    ...
    private ArrayList<OthersEntity> others;

    public void setLimit(int limit) {
        this.limit = limit;
    }

    public void setSubscribed(ArrayList<?> subscribed) {
        this.subscribed = subscribed;
    }

    public void setOthers(ArrayList<OthersEntity> others) {
        this.others = others;
    }
    ...
    public ArrayList<?> getSubscribed() {
        return subscribed;
    }

    public ArrayList<OthersEntity> getOthers() {
        return others;
    }
